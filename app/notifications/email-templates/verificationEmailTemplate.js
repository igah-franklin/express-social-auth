...
function getVerificationEmailTemplate(userEmail, verificationLink) {
    return `
                    ...
                    <table width="100%">
                      ...
                      <tr>
                        <td style="text-align:center;">
                          ...
                          <p>Thank you for signing up with us! Please verify your email address by clicking the link below:</p>
